...
class FishingModel(Model):
    ...
    def __init__(self, height=40, width=40,
                 ...
                 initial_wallet_survival = 12*2, prop_plus_wallet_spawn = 1, avg_wallet_spawn_threshold = 2.0,
                ):
        super().__init__()
        ...
        self.yearly_quotum = 0.1 * initial_fish * initial_school_size
    ...
    def run_model(self, step_count=5000):
        ...
        while i < step_count:
            ...
            print(self.total_yearly_caught)
            #print(i)
